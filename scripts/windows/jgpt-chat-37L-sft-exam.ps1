...
#
# Interactive InferChat for 37L exam SFT finetune (model_best.bin).
#   .\scripts\windows\jgpt-chat-37L-sft-exam.ps1
#   .\scripts\windows\jgpt-chat-37L-sft-exam.ps1 --prompt "Privet"
...
$ModelDefault = "checkpoints\sft_37L_exam\model_best.bin"
