...
#
# Interactive InferChat for 37L short SFT finetune (model_best.bin).
#   .\scripts\windows\jgpt-chat-37L-sft-short.ps1
#   .\scripts\windows\jgpt-chat-37L-sft-short.ps1 --prompt "Privet"
...
$ModelDefault = "checkpoints\sft_37L_short_ft\model_best.bin"
